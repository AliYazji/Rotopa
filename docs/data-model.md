...
**لسا ما تهاجر:** كميات وتاريخ حركة المخزون الفعلية من `Item_stock_tb`/`Item_stock_Details`
(178 ألف صف) — كل صنف مُرحَّل يبدأ برصيد صفر. راجع `etl/README.md` لسبب هالقرار وخطة رصيد
افتتاحي للمخزون لاحقاً. المشتريات (الوحدة 11) لسا ما اتبنت — `stock_moves.move_type` محجوز
لها مسبقاً (`purchase_in`).
