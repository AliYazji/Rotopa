  ...
  return (
    <>
      <div className="row" style={{ justifyContent: 'space-between' }}>
        <h1>طلبات البيع</h1>
        <Link to="/sales-orders/new" className="btn btn-primary">طلب جديد</Link>
      </div>
      <div className="card" style={{ padding: 0, overflowX: 'auto' }}>
        <table>
          ...
          <tbody>
            ...
            {data?.map((o) => (
              <tr key={o.id} className="rowlink" onClick={() => nav(`/sales-orders/${o.id}`)}>
